...
The Linear Regression model has lower RMSE and MAE, but higher Rsquared compared to Linear Regression model with forward selection. Thus, the Linear Regression model has performance.
...
The three models have similar Rsquared results. Thus, based on RMSE and MAE results, the Linear Regression model has better performance compared to the Ridge Regression model and the Ridge Regression model with 10-fold cross-validation.
